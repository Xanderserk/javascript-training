...
Ответьте на вопрос: как быстрее получить значение glasses – через pockets.glasses или через head.glasses? ------> без разницы.
--- */
...
Какой объект получит свойство full при вызове rabbit.eat(): animal или rabbit? -----> rabbit. Он берет eat() в качестве метода, но записывает в объект, что перед точкой.
